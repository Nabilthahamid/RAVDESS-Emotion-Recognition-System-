# ESRA-RELA++: An Explainable Saliency-Guided and AU-Dynamic Multimodal Framework for Subject-Independent RAVDESS Emotion Recognition
...
This project proposes and evaluates **ESRA-RELA++**, a saliency-guided and AU-dynamic multimodal emotion-recognition framework.
...
| Meta-fusion | Computed for stage ablation, but not used in the final decision when `--dual_fusion_blend 1.0` is used |
...
final_results/r05_fold_metrics.png
